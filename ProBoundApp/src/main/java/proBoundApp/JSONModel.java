...
public class JSONModel {
	...
	public JSONModel(String jsonPath, String jsonSchemaPathIn) {
    	...
    	//Note that we need to validate the model twice to fully fill in empty objects.
    	validateModelSchema();
    ...
    static void validateModelCoefficients(JSONObject oModel, String coefficientKey) {
		...
		//CHECK: We learn the number of experiments from the first binding mode and make sure that everything else is consistent with this.
    ...
    public static JSONArray loadJSONArrayFromFile(String jsonPath) {
